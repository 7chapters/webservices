 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://ws.team.ch01.webservice._7chapters.info/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    public TeamsService() {
        super(TEAMSSERVICE_WSDL_LOCATION, new QName("http://ws.team.ch01.webservice._7chapters.info/", "TeamsService"));
    }
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://ws.team.ch01.webservice._7chapters.info/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.team.ch01.webservice._7chapters.info/", "TeamsPort"), Teams.class, features);
    }
